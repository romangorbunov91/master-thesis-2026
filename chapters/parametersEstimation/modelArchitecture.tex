...
Преобразование тензора декодера аналогично преобразованию, выполняемому на входе \enquote{Bottleneck}, только с предварительным увеличением длины тензора в 2 раза алгоритмом \enquote{nn.Upsample}:
\begin{equation*}
