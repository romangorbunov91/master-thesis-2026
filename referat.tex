...
\begin{document}
    ...
    \clearpage
    \section{Соответствие работы направлению подготовки \enquote{27.04.03 -- Системный анализ и управление}}\label{appendix:skills}
    Работа соответствует направлению подготовки \enquote{27.04.03 -- Системный анализ и управление} по следующим общепрофессиональным и профессиональным компетенциям Федерального государственного образовательного стандарта высшего образования и образовательного стандарта университета ИТМО: 
    \begin{enumerate}
    ...
    Частотные характеристики измерены в диапазоне частот от 10~Гц до 49~кГц. Измерения выполнены двумя способами: сертифицированным измерителем частотных характеристик (AP300) и разработанным алгоритмом внутрисхемного измерения (Digital Points). Результаты на рисунке \ref{fig:freqresp} обозначены \enquote{AP} и \enquote{DP}, соответственно. Алгоритм и пробор настроены на одинаковую продолжительность измерений, составляющую порядка 120~секунд на характеристику в ${K=300}$ частот.
