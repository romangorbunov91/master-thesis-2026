...
\begin{document}
    ...
    Система управления вторичного источника электропитания представлена в виде обобщенной системы аналого-цифрового преобразования и цифровой обработки сигналов с воздействием на объект управления посредством импульсной модуляции с постоянным периодом ${T_{d}}$. Период определяется базовой частотой дискретного регулирования ${f_{d} = 1 / T_{d}}$.
