...
\begin{document}
    ...
    \vspace{3mm}\\
    \fontsize{14pt}{15pt}\selectfont Секретарь ГЭК \hfill Матвеева Милена Вадимовна
    ...
    В то же время современные источники электропитания все чаще оснащаются программным управлением (real-time embedded control), что создает предпосылки для внутрисхемного измерения характеристик. Результаты измерений могут использоваться для автоматизированного тестирования, настройки и контроля качества изделий в производственном цикле.
    ...
    \clearpage
    Теоретически комплексный коэффициент передачи звена преобразования тока в напряжение силового каскада источника питания, частотные характеристики которого изображены на рисунке~\ref{fig:freqresp}, аппроксимируется малосигнальной моделью, содержащей правый ноль, левый ноль и левый полюс
    \begin{equation*}
