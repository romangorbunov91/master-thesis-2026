...
\usepackage{caption}
\captionsetup[figure]{name=Рисунок, labelsep=period, justification=centering, aboveskip=0pt, belowskip=0pt}
\captionsetup[table]{name=Таблица, labelsep=period, justification=raggedright, singlelinecheck=off, aboveskip=0pt, belowskip=0pt}
